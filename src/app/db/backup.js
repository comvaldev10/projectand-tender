...
//   `company_activity_id` int(11) NOT NULL AUTO_INCREMENT,
...
// DROP TABLE IF EXISTS `company_award_type`;
// CREATE TABLE `company_award_type` (
//   `company_award_type_id` int(11) NOT NULL AUTO_INCREMENT,
//   `company_award_type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
//   `soft_delete` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
//   PRIMARY KEY (`company_award_type_id`)
// ) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
// DROP TABLE IF EXISTS `company_specialize`;
// CREATE TABLE `company_specialize` (
//   `company_specialize_id` int(11) NOT NULL AUTO_INCREMENT,
//   `company_specialize` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
//   `soft_delete` tinyint(1) DEFAULT 0,
//   PRIMARY KEY (`company_specialize_id`)
// ) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
//   `our_address` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
//   `get_in_touch` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
//   `call_to_action_descrip` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
//   `call_to_action_button_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
//   `call_to_action_button_link` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
//   `call_to_action_bar` tinyint(1) DEFAULT 0,
...
//   `seo_keyword` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
//   `seo_slug` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
//   `site_id` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
//   `soft_delete` tinyint(1) DEFAULT 0,
//   `publish` tinyint(1) DEFAULT 0,
//   `opening` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '',
...
//   `cookie_info_id` int(11) NOT NULL AUTO_INCREMENT,
//   `message` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
//   `seo_title` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
//   `seo_description` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
//   `seo_keyword` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
//   `ownership_type_id` int(11) NOT NULL AUTO_INCREMENT,
...
//   `policy_info_id` int(11) NOT NULL AUTO_INCREMENT,
//   `message` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
//   `seo_title` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
//   `seo_description` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
//   `seo_keyword` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
//   `publish` tinyint(1) DEFAULT 1,
//   `soft_delete` tinyint(1) DEFAULT 0,
//   PRIMARY KEY (`policy_info_id`)
// ) ENGINE=InnoDB DEFAULT CHARSET=latin1;


// DROP TABLE IF EXISTS `project_profile`;
// CREATE TABLE `project_profile` (
//   `project_profile_id` int(11) NOT NULL AUTO_INCREMENT,
//   `project_profile` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
//   `soft_delete` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
//   PRIMARY KEY (`project_profile_id`)
// ) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
// DROP TABLE IF EXISTS `request_assistance_type`;
// CREATE TABLE `request_assistance_type` (
//   `request_assistance_type_id` int(11) NOT NULL AUTO_INCREMENT,
//   `request_assistance_type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
//   `soft_delete` tinyint(1) DEFAULT 0,
//   PRIMARY KEY (`request_assistance_type_id`)
// ) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
//   ` tender_type_id` int(11) NOT NULL AUTO_INCREMENT,
//   ` tender_type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
//   `soft_delete` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
//   `term_info_id` int(11) NOT NULL AUTO_INCREMENT,
//   `message` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
//   `seo_title` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
//   `seo_description` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
//   `seo_keyword` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
// DROP TABLE IF EXISTS `what_are_you_interested_for`;
// CREATE TABLE `what_are_you_interested_for` (
//   `what_are_you_interested_for_id` int(11) NOT NULL AUTO_INCREMENT,
//   `what_are_you_interested_for` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
//   `soft_delete` tinyint(1) DEFAULT 0,
//   PRIMARY KEY (`what_are_you_interested_for_id`)
// ) ENGINE=InnoDB DEFAULT CHARSET=latin1;
